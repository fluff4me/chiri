...
declare const BINARY_BITWISE_OPERATORS: readonly ["&", "|", "^", "<<", ">>", ">>>"];
declare const UNARY_BITWISE_OPERATORS: readonly ["~"];
...
declare const BINARY_OTHER_OPERATORS: readonly ["is"];
declare const UNARY_OTHER_OPERATORS: readonly ["exists"];
export type Operator = (typeof binaryNumericOperators)[number] | (typeof unaryNumericOperators)[number] | (typeof BINARY_BITWISE_OPERATORS)[number] | (typeof UNARY_BITWISE_OPERATORS)[number] | (typeof binaryBooleanOperators)[number] | (typeof unaryBooleanOperators)[number] | (typeof binaryStringOperators)[number] | (typeof UNARY_OTHER_OPERATORS)[number] | (typeof BINARY_OTHER_OPERATORS)[number];
