...
export default class ChiriTypeManager {
    ...
    registerBinaryOperator(typeA: string, operator: string, typeB?: string, output?: string, reversible?: boolean): void;
    registerUnaryOperator(operator: string, type: string, output?: string): void;
