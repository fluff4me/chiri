...
export type MacroResult = ChiriCompilerVariable | ChiriMacro | ChiriMacroUse | ChiriShorthand | ChiriImport | ChiriEach | ChiriAlias | ChiriDo | ChiriAssignment | ChiriFor | ChiriFunction | ChiriWhile | ChiriIf | ChiriElse | ChiriInclude | ChiriCSSImport | ChiriAnimation | ChiriAnimate | ChiriAfter | ChiriFontFace | ChiriSelect | ChiriBreak | ChiriContinue;
