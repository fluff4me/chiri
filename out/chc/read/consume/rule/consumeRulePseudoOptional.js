...
(function (factory) {
    ...
    exports.default = async (reader) => {
        ...
        const result = _1.default
            ...
            ?? consumePseudoType(reader, "pseudo", "before", "after", "view-transition", "backdrop", "range-thumb", "range-track", "placeholder", "details-content", "swatch-wrapper", "swatch", "marker");
        if (!result)
            return undefined;
