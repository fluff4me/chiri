...
module.exports = class ESWriter {
	...
	/** 
	 * @param {Omit<ThetaWord, "type">} source 
	 * @param {string=} word
	 */
	...
	/**
	 * @param {ThetaStatement} statement 
	 */
	...
	/** @param {ThetaDeclaration} declaration */
	...
	/** @param {ThetaBinaryExpression | ThetaUnaryExpression} expression */
	...
	/** @param {ThetaBinaryExpression} expression */
	...
	writeLiteral (literal) {
		switch (literal.subType) {
			...
			default: throw this.error(`No ES write definition for type '${literal.subType === "other" ? literal.valueType : /** @type {ThetaLiteralValue} */(literal).subType}'`)
		}
	}

	/** @param {ThetaIIFE} iife */
	writeIIFE (iife) {
		throw this.error("I don't know how to write IIFEs yet!");
	}

	/** @param {ThetaDocumentation} documentation */
