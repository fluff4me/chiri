...
const ThetaTypeManager = require("./ThetaTypeManager");

class ThetaReader {

	#types = new ThetaTypeManager();
	...
	/** 
	 * @param {string} name
	 * @returns {import("./ThetaTypeManager").ThetaTypeDefinition | undefined}
	 */
